...
## [0.1.0](https://github.com/GenjiruSUchiwa/repo-router/releases/tag/v0.1.0) - 2026-08-18

### Added

- *(cli)* rr impact reports a change's reach, and says which parts it could not
- *(core, cli)* rr check reports what it finds and repairs nothing
- *(core, cli)* freeze the v1 query surface
...
- *(core)* review corrections for the C# extractor
...
- *(cli)* shard the corpus, and refuse a run that does not add up
